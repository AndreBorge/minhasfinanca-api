...
import com.borges.minhasfinancas.service.impl.UsuarioServiceImpl;
...
public class UsuarioServiceTest {
	...
	public void deveLancarErroQuandoNaoEncontrarUsuarioCadastradoComEmailInformado() {
		...
		Assertions.assertThat(exception).isInstanceOf(ErroAutenticacao.class)
				.hasMessage("Usuario não encontrado para o email não encontrado");
	}

	@Test
	public void deveLancarErroQuandoSenhaNaoForValida() {
		// cenario
		String senha = "senha";
