...
import com.borges.minhasfinancas.model.repository.LancamentoRepository;
import com.borges.minhasfinancas.service.LancamentoService;

public class LancamentoServiseImpl implements LancamentoService{

	private LancamentoRepository repository;

	public LancamentoServiseImpl(LancamentoRepository repository) {
	...
	@Override
	public void autualizarStatus(Lancamento lancamento, StatusLancamento status) {
		lancamento.setStatus(status);
		autualizar(lancamento);		
	}
	...
	public void validar(Lancamento lancamento) {
		...
		if(lancamento.getUsuario() == null || lancamento.getUsuario().getId() == null) {
			throw new RegraNegocioException("Informe um Uuário");
		}
